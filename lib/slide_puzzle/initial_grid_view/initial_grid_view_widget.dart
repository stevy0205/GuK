...
class InitialGridViewWidget extends StatefulWidget {
  const InitialGridViewWidget({Key? key}) : super(key: key);

  @override
  _InitialGridViewWidgetState createState() => _InitialGridViewWidgetState();
}
    ...
    return Container(
      ...
      child: Builder(
        builder: (context) {
          ...
          if (initNumList.isEmpty) {
            return InitialGridViewWidget();
          }
