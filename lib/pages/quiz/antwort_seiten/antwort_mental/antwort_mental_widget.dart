...
import 'antwort_mental_model.dart';
export 'antwort_mental_model.dart';

class AntwortMentalWidget extends StatefulWidget {
  const AntwortMentalWidget({
    Key? key,
    int? index,
    this.answer,
    int? score,
  ...
  @override
  _AntwortMentalWidgetState createState() => _AntwortMentalWidgetState();
}

class _AntwortMentalWidgetState extends State<AntwortMentalWidget> {
  late AntwortMentalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AntwortMentalModel());
