...
import 'antwort_geburt_model.dart';
export 'antwort_geburt_model.dart';

class AntwortGeburtWidget extends StatefulWidget {
  const AntwortGeburtWidget({
    Key? key,
    int? index,
    this.answer,
    int? score,
  ...
  @override
  _AntwortGeburtWidgetState createState() => _AntwortGeburtWidgetState();
}

class _AntwortGeburtWidgetState extends State<AntwortGeburtWidget> {
  late AntwortGeburtModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AntwortGeburtModel());
