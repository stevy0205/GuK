...
import 'quiz_k_h_g_w_model.dart';
export 'quiz_k_h_g_w_model.dart';

class QuizKHGWWidget extends StatefulWidget {
  const QuizKHGWWidget({
    Key? key,
    int? index,
    int? score,
  })  : this.index = index ?? 0,
  ...
  @override
  _QuizKHGWWidgetState createState() => _QuizKHGWWidgetState();
}

class _QuizKHGWWidgetState extends State<QuizKHGWWidget>
    with TickerProviderStateMixin {
  late QuizKHGWModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuizKHGWModel());
