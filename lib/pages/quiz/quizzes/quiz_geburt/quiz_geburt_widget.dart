...
import 'quiz_geburt_model.dart';
export 'quiz_geburt_model.dart';

class QuizGeburtWidget extends StatefulWidget {
  const QuizGeburtWidget({
    Key? key,
    int? index,
    int? score,
  })  : this.index = index ?? 0,
  ...
  @override
  _QuizGeburtWidgetState createState() => _QuizGeburtWidgetState();
}

class _QuizGeburtWidgetState extends State<QuizGeburtWidget>
    with TickerProviderStateMixin {
  late QuizGeburtModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuizGeburtModel());
