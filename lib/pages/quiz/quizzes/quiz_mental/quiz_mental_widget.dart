...
import 'quiz_mental_model.dart';
export 'quiz_mental_model.dart';

class QuizMentalWidget extends StatefulWidget {
  const QuizMentalWidget({
    Key? key,
    int? index,
    int? score,
  })  : this.index = index ?? 0,
  ...
  @override
  _QuizMentalWidgetState createState() => _QuizMentalWidgetState();
}

class _QuizMentalWidgetState extends State<QuizMentalWidget>
    with TickerProviderStateMixin {
  late QuizMentalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuizMentalModel());
