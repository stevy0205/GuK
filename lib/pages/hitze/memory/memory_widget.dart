                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              setState(() {
                                FFAppState().card2Flipped = false;
                                FFAppState().card5Flipped = false;
                                FFAppState().checkButtonColor =
                                    Color(4281979584);
                                FFAppState().card1flipped = false;
                                FFAppState().card3flipped = false;
                                FFAppState().card4flipped = false;
                                FFAppState().card10flipped = false;
                                FFAppState().pair6and8isSolved = false;
                                FFAppState().card6flipped = false;
                                FFAppState().card7flipped = false;
                                FFAppState().card8flipped = false;
                                FFAppState().checkedStatus = ' ';
                                FFAppState().card9flipped = false;
                                FFAppState().card11flipped = false;
                                FFAppState().card12flipped = false;
                                FFAppState().pair2and5isSolved = false;
                                FFAppState().pair1and7isSolved = false;
                                FFAppState().pair3and10isSolved = false;
                                FFAppState().pair4and12isSolved = false;
                                FFAppState().card2and5color = Color(4285376237);
                                FFAppState().card6and8color = Color(4285376237);
                                FFAppState().card4and12color =
                                    Color(4285376237);
                                FFAppState().card1and7color = Color(4285376237);
                                FFAppState().card3and10color =
                                    Color(4285376237);
                              });
                            },
