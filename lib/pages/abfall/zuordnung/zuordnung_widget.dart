                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  setState(() {
                                    ...
                                    FFAppState().recycleChosen = false;
                                    FFAppState().nonRecycleChosen = false;
                                    FFAppState().pic5Solved = false;
                                    FFAppState().pic4Solved = false;
                                    FFAppState().sonderAbfallChosen = false;
                                    FFAppState().abfallZuordnungAuswertung =
                                        'Wähle aus';
                                    FFAppState().pic1Color = Color(4278740397);
                                    FFAppState().pic3Solved = false;
                                    FFAppState().pic2Solved = false;
                                    FFAppState().pic2Color = Color(4278740397);
                                    FFAppState().pic3Color = Color(4278740397);
                                    FFAppState().pic4Color = Color(4278740397);
                                    FFAppState().pic5Color = Color(4278740397);
                                    FFAppState().pic6Color = Color(4278740397);
                                    FFAppState().recycleColor =
                                        Color(4278740397);
                                    FFAppState().nonRecycleColor =
                                        Color(4278740397);
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            setState(() {
                              ...
                              FFAppState().pic5Color = Color(4278740397);
                              FFAppState().pic6Color = Color(4278740397);
                              FFAppState().recycleColor = Color(4278740397);
                              FFAppState().nonRecycleColor = Color(4278740397);
                              FFAppState().sonderColor = Color(4278740397);
                              FFAppState().pic1Solved = false;
                            });
                          },
